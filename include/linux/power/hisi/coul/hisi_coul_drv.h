...
struct hisi_coul_ops {
    ...
    void (*save_chrg_rbat_over_standard)(int);
    int (*get_bad_battery_flag)(void);
...
extern void hisi_save_chrg_rbat_over_standard(int chrg_rbat_over_standard);
extern int hisi_get_bad_battery_flag(void);
