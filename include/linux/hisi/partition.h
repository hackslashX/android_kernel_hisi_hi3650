...
static const struct partition partition_table_emmc[] =
{
    ...
    {PART_ERECOVERY_KERNEL  ,  306*1024, 24*1024, EMMC_USER_PART},/* erecovery_kernel  24M  p22*/
    {PART_ERECOVERY_RAMDISK  , 330*1024, 32*1024, EMMC_USER_PART},/* erecovery_ramdisk 32M  p23*/
    {PART_ERECOVERY_VENDOR  ,  362*1024,  8*1024, EMMC_USER_PART},/* erecovery_vendor  8M   p24*/
    {PART_RESERVED2,           370*1024, 64*1024, EMMC_USER_PART}, /* reserved2        64M  p25*/
    {PART_TEEOS,               434*1024,  4*1024, EMMC_USER_PART}, /* teeos            4M   p26*/
    {PART_TRUSTFIRMWARE,       438*1024,  2*1024, EMMC_USER_PART}, /* trustfirmware    2M   p27*/
    {PART_SENSORHUB,           440*1024, 16*1024, EMMC_USER_PART}, /* sensorhub        16M  p28*/
    {PART_FW_HIFI,             456*1024, 12*1024, EMMC_USER_PART}, /* hifi             12M  p29*/
    {PART_KERNEL  ,            468*1024, 32*1024, EMMC_USER_PART}, /* boot             32M  p30*/
#else
    {PART_ERECOVERY_KERNEL  ,  306*1024, 24*1024, EMMC_USER_PART},/* erecovery_kernel  24M  p22*/
    {PART_ERECOVERY_RAMDISK  , 330*1024, 32*1024, EMMC_USER_PART},/* erecovery_ramdisk 32M  p23*/
    {PART_ERECOVERY_VENDOR  ,  362*1024, 16*1024, EMMC_USER_PART},/* erecovery_vendor 16M   p24*/
    {PART_RESERVED2,           378*1024, 64*1024, EMMC_USER_PART}, /* reserved2        64M  p25*/
    {PART_TEEOS,               442*1024,  4*1024, EMMC_USER_PART}, /* teeos            4M   p26*/
    {PART_TRUSTFIRMWARE,       446*1024,  2*1024, EMMC_USER_PART}, /* trustfirmware    2M   p27*/
    {PART_SENSORHUB,           448*1024, 16*1024, EMMC_USER_PART}, /* sensorhub        16M  p28*/
    {PART_FW_HIFI,             464*1024, 12*1024, EMMC_USER_PART}, /* hifi             12M  p29*/
    {PART_KERNEL  ,            476*1024, 24*1024, EMMC_USER_PART}, /* boot             24M  p30*/
#endif
    {PART_RAMDISK  ,         500*1024,  16*1024,  EMMC_USER_PART},/* ramdisk         16M    p31*/
    {PART_RECOVERY_RAMDISK  ,516*1024,  32*1024,  EMMC_USER_PART},/* recovery_ramdisk 32M   p32*/
    {PART_RECOVERY_VENDOR  , 548*1024,  16*1024,  EMMC_USER_PART},/* recovery_vendor 16M    p33*/
    {PART_DTS  ,             564*1024,  32*1024,  EMMC_USER_PART}, /* dtimage          32M  p34*/
    {PART_DTO  ,             596*1024,  24*1024,  EMMC_USER_PART}, /* dtimage          24M  p35*/
    {PART_RECOVERY_VBMETA  , 620*1024,  2*1024,   EMMC_USER_PART}, /* recovery_vbmeta_a  2M p36*/
    {PART_ERECOVERY_VBMETA  ,622*1024,  2*1024,   EMMC_USER_PART}, /* erecovery_vbmeta_a 2M p37*/
    {PART_VBMETA  ,          624*1024,  4*1024,   EMMC_USER_PART}, /* PART_VBMETA_A     4M  p38*/
    {PART_MODEM,             628*1024,  64*1024,  EMMC_USER_PART}, /* modem            64M  p39*/
    {PART_MODEM_DSP,         692*1024,  16*1024,  EMMC_USER_PART}, /* modem_dsp        16M  p40*/
    {PART_MODEM_DTB,         708*1024,  8*1024,   EMMC_USER_PART}, /* modem_dtb        8M   p41*/
    {PART_DFX,               716*1024,  16*1024,  EMMC_USER_PART}, /* dfx              16M  p42*/
    {PART_3RDMODEM,          732*1024,  64*1024,  EMMC_USER_PART}, /* 3rdmodem         64M  p43*/
    {PART_CACHE,             796*1024, 128*1024,  EMMC_USER_PART}, /* cache            64M  p44*/
    {PART_ODM  ,             924*1024,  128*1024, EMMC_USER_PART},/* odm               128M p45*/
    {PART_HISITEST0,         1052*1024, 2*1024,   EMMC_USER_PART}, /* hisitest0        2M   p46*/
    {PART_HISITEST1,         1054*1024, 2*1024,   EMMC_USER_PART}, /* hisitest1        2M   p47*/
#ifdef CONFIG_VENDORIMAGE_FILE_SYSTEM_TYPE
    {PART_PATCH,             1056*1024,  32*1024,  EMMC_USER_PART}, /* patch            32M  p48*/
    {PART_BOOTFAIL_INFO,     1088*1024,  2*1024,   EMMC_USER_PART}, /* bootfail info    2M   p49*/
    {PART_RRECORD,           1090*1024,  16*1024,  EMMC_USER_PART}, /* rrecord          16M  p50*/
    {PART_RESERVED3,         1106*1024,  14*1024,  EMMC_USER_PART}, /* rrecord          14M  p51*/

#ifdef CONFIG_MARKET_OVERSEA
    {PART_SYSTEM,            1120*1024, 3008*1024,EMMC_USER_PART}, /* system           3008M p52*/
    {PART_CUST,              4128*1024, 192*1024, EMMC_USER_PART}, /* cust             192M  p53*/
    {PART_VERSION,           4320*1024, 32*1024,  EMMC_USER_PART}, /* version          32M    p54*/
    {PART_VENDOR,            4352*1024, 608*1024, EMMC_USER_PART}, /* vendor           608M  p55*/
    {PART_PRODUCT,           4960*1024, 192*1024, EMMC_USER_PART}, /* product          192M   p56*/
    {PART_HISITEST2,         5152*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p57*/
    {PART_USERDATA,          5156*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p58*/
#elif defined CONFIG_MARKET_INTERNAL
    {PART_SYSTEM,            1120*1024, 2688*1024,EMMC_USER_PART}, /* system           2688M p52*/
    {PART_CUST,              3808*1024, 192*1024, EMMC_USER_PART}, /* cust             192M  p53*/
    {PART_VERSION,           4000*1024, 32*1024,  EMMC_USER_PART}, /* version          32M    p54*/
    {PART_VENDOR,            4032*1024, 608*1024, EMMC_USER_PART}, /* vendor           608M  p55*/
    {PART_PRODUCT,           4640*1024, 192*1024, EMMC_USER_PART}, /* product          192M   p56*/
    {PART_HISITEST2,         4832*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p57*/
    {PART_USERDATA,          4836*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p58*/
#else
    {PART_SYSTEM,            1120*1024, 1984*1024,EMMC_USER_PART}, /* system           1984M p52*/
    {PART_CUST,              3104*1024, 192*1024, EMMC_USER_PART}, /* cust             192M  p53*/
    {PART_VERSION,           3296*1024, 32*1024,   EMMC_USER_PART}, /* version         32M    p54*/
    {PART_VENDOR,            3328*1024, 608*1024, EMMC_USER_PART}, /* vendor           608M  p55*/
    {PART_PRODUCT,           3936*1024, 192*1024,  EMMC_USER_PART}, /* product         192M   p56*/
    {PART_HISITEST2,         4128*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p57*/
    {PART_USERDATA,          4132*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p58*/
#endif
#else
#ifdef CONFIG_MARKET_OVERSEA
    {PART_SYSTEM,            1056*1024, 3584*1024,EMMC_USER_PART}, /* system           3584M p48*/
    {PART_CUST,              4640*1024, 512*1024, EMMC_USER_PART}, /* cust             512M  p49*/
    {PART_HISITEST2,         5152*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p50*/
    {PART_USERDATA,          5156*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p51*/
#elif defined CONFIG_MARKET_INTERNAL
    {PART_SYSTEM,            1056*1024, 3264*1024,EMMC_USER_PART}, /* system           3264M p48*/
    {PART_CUST,              4320*1024, 512*1024, EMMC_USER_PART}, /* cust             512M  p49*/
    {PART_HISITEST2,         4832*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p50*/
    {PART_USERDATA,          4836*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p51*/
#else
    {PART_SYSTEM,            1056*1024, 2560*1024,EMMC_USER_PART}, /* system           2560M p48*/
    {PART_CUST,              3616*1024, 512*1024, EMMC_USER_PART}, /* cust             512M  p49*/
    {PART_HISITEST2,         4128*1024, 4*1024,   EMMC_USER_PART}, /* hisitest2        4M    p50*/
    {PART_USERDATA,          4132*1024, 4096*1024,EMMC_USER_PART}, /* userdata         4096M p51*/
#endif
#endif
    {"0", 0, 0, 0},                                        /* total 8228M*/
};
