...
#define BATTERY_TEMPERATURE_10_C            (10)
#define BATTERY_TEMPERATURE_20_C            (20)
#define BATTERY_TEMPERATURE_30_C            (30)
...
#define RBAT_CHECK_DELTA_CURRENT	(100)
...
#define RBAT_RECORD_LEN  (6)
#define RBAT_OVER_RANGE  (4)
struct rbat_over_standard_record {
	unsigned int cur_index;
	unsigned int rbat_over_standard;
	unsigned int rbat_records[RBAT_RECORD_LEN];
};
...
struct charge_device_info {
	...
	unsigned int refer_rbat_10_degree;
	unsigned int refer_rbat_20_degree;
	unsigned int refer_rbat_30_degree;
	unsigned int rbat_check_enable;
