...
#define DDR_RSV_RSV1_BASE_AP DDR_CODE_END_AP
#define DDR_RSV_RSV1_SIZE (0x180000)
#define DDR_RSV_RSV1_END_AP (DDR_RSV_RSV1_BASE_AP + DDR_RSV_RSV1_SIZE)
#define DDR_DUMP_BASE_AP DDR_RSV_RSV1_END_AP
#define DDR_DUMP_SIZE (0x80000)
#define DDR_DUMP_END_AP (DDR_DUMP_BASE_AP + DDR_DUMP_SIZE)
#define DDR_RSV_RSV2_BASE_AP DDR_DUMP_END_AP
