...
#define DFMO_VSYNC_UPTHRESHOLD		(60)
#define DFMO_VSYNC_DOWNDIFFERENCTIAL	(15)
#define DFMO_NO_VSYNC_UPTHRESHOLD	(35)
...
#define DFMO_DEFAULT_ANIMATION_BOOST_FREQ	(360000000)
#define DFMO_OPENCL_BOOST_ON		(1)
#define DFMO_OPENCL_BOOST_DN		(1)
#define DFMO_MIN_OPENCL_BOOST_FREQ	(120000000)
...
#define DFMO_DEFAULT_HISPEED_FREQ	(360000000)

#ifdef DFMO_REQUEST_QOS_CPU_DMA_LATENCY
#define DFMO_MIN_FREQ_FOR_QOS_CPU_DMA_LATENCY		(360000000)
#define DFMO_MAX_FREQ_FOR_QOS_CPU_DMA_LATENCY		(900000000)
#define DFMO_DEFAULT_FREQ_FOR_QOS_CPU_DMA_LATENCY	(900000000)
