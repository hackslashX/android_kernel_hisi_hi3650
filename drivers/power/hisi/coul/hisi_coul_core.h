...
#define LOW_INT_VOL_PERCENT 80
#define LOW_INT_VOL_HIGH_THRESHOLD 3
...
#define ISCD_CHARGE_CYCLE_MIN  11
...
#define BAD_BATTERY_NV_FLAG   0xAAAA
#define GOOD_BATTERY_NV_FLAG 0x5555

#define DATE20160101  "16101"
#define DATE20161101  "16B01"
...
struct ss_coul_nv_info{
    ...
    unsigned short bad_battery_flag;
};
...
struct smartstar_coul_device
{
    ...
    int rbatt;
    int rbatt_ratio;
    int chg_rbat_over_standard;
    int bad_battery_flag;
    int r_pcb;
